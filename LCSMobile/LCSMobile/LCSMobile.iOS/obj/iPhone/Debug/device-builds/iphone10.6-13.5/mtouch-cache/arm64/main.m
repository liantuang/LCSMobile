...
extern void *mono_aot_module_LCSMobile_iOS_info;
...
extern void *mono_aot_module_LCSMobile_info;
...
extern void *mono_aot_module_CFX_info;
extern void *mono_aot_module_Newtonsoft_Json_info;
extern void *mono_aot_module_Amqp_Net_info;
...
{
	mono_aot_register_module (mono_aot_module_LCSMobile_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_LCSMobile_info);
	...
	mono_aot_register_module (mono_aot_module_CFX_info);
	mono_aot_register_module (mono_aot_module_Newtonsoft_Json_info);
	mono_aot_register_module (mono_aot_module_Amqp_Net_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "LCSMobile.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
